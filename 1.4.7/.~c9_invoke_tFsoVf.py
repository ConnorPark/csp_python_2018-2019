...
def round_corners_one_image(original_image, percent_of_side=.3):
    ...
    #new change
    black_layer = PIL.Image.new('RGBA', logo.size, (0,0,0,225))
    ...
    result.paste(back, ((width // 2) - wlogo - 10, (height // 2) - hlogo - 10), mask=logo) #new change
    result.paste(black_layer, ((width // 2) - 15, (height // 2) - hlogo), mask=logo) #new change
