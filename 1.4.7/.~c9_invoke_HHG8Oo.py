...
#-------------------------------------------------------------------------------    
    if picking_color == 'red':
        ...
        colorchose = (0,255,0,255)
    elif picking_color == 'purple':
        colorchose = (255,0,255,255)
    elif picking_color == 'magenta':
        colorchose = (255,255,0,255)
    elif picking_color == 'cyan':
        colorchose = (0,255,255,255)
...
#-------------------------------------------------------------------------------
    ...
    add_text.text(((width // 2), (height // 2)), text, font=font, fill=(255, 255, 255, 255))
    return result
